        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <Formik enableReinitialize initialValues={getSlider ?? {
                description: '',
                featureSliderID: '',
                imageUrl: '',
                title: '',
                ...
                title3: '',
                status: false,
              }} validationSchema={sliderYup} onSubmit={(values, formikHelpers) => handleSubmit(values, formikHelpers)} >
                {({ touched, errors, values, isValid, dirty, setFieldValue, setFieldTouched }) => (
                  <Form>
                    <div className='row fw-medium'>
                      ...
                      <div className='col-md-6 col-sm-12 mt-3'>
                        <Field
                          ...
                          onChange={(event: any, newValue: any) => { setFieldValue('status', newValue ? newValue.value : ''); }}
                    ...
                    <button type="submit"   {...(isValid && dirty ? { 'data-bs-dismiss': 'modal' } : {})} className="btn text-white mt-3  w-100" style={{ backgroundColor: '#6bbeb7' }}>Güncelle</button>
                  </Form>
                )}
              </Formik>
            </div>
